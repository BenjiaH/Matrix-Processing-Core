...
#
# Generated by export_simulation on Sun Apr 09 03:35:02 +0100 2023
#
################################################################################
...
'-reset_run' switch to the './dpram_1024x16.sh' script.

./dpram_1024x16.sh -reset_run
...
./dpram_1024x16.sh -noclean_files

For more information on the script, please type './dpram_1024x16.sh -help'.
