...
#
# Generated by export_simulation on Sat Apr 01 19:36:09 +0100 2023
#
################################################################################
...
'-reset_run' switch to the './dpram_1024x64_D.sh' script.

./dpram_1024x64_D.sh -reset_run
...
./dpram_1024x64_D.sh -noclean_files

For more information on the script, please type './dpram_1024x64_D.sh -help'.
